...
`function normalizeReleaseNotes(text) {
  ...
  // A lot of older PackRat submissions were written as one giant comma-heavy
  // "Initial release" sentence. Convert that into scannable value bullets instead
  // of pasting a wall of text into Maker Console.
