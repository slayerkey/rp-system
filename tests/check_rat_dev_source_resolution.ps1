...
$preflightScript = Get-Content (Join-Path $RepoRoot "tools\local\rat-dev-preflight.ps1") -Raw
if ($preflightScript -notmatch '\+refs/heads/main:refs/remotes/origin/main') {
    throw "Rat Dev preflight must explicitly refresh origin/main."
}
