...
let websocket=null,uuid=null,actionUuid="",settings={},globalSettings={},monitorRows=[],proUrl=PACKRAT_MAKER_URL;
...
function build(){
  ...
  document.getElementById("topPro")?.addEventListener("click",()=>openUrl(proUrl||PACKRAT_MAKER_URL));
  ...
  document.getElementById("pro")?.addEventListener("click",()=>openUrl(proUrl||PACKRAT_MAKER_URL));
}
