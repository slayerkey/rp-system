import type { InputMode, MouseButton, Rect, WheelAxis } from "./win32/input";

export type { InputMode, MouseButton, Rect, WheelAxis } from "./win32/input";
...
interface NativeInputApi {
	...
	mouseWheel(notches: number, axis?: WheelAxis): unknown;
	wheelToActiveWindow(notches: number, axis?: WheelAxis): boolean;
	inputSize(): number;
	assertLayout(): void;
...
export const wheelToActiveWindow = impl.wheelToActiveWindow;
