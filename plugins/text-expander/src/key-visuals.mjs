...
const GLYPHS = {
  insert:'<path d="M45 35h54v52H45z"/><path d="M57 49h30M57 61h30M57 73h21"/><path d="M101 30v20M91 40h20" stroke="#FFB21E"/>',
  library:'<rect x="42" y="32" width="60" height="56" rx="6"/><path d="M55 48h34M55 61h34M55 74h24"/><path d="M33 42v47h58"/><circle cx="103" cy="33" r="4" fill="#FFB21E" stroke="none"/>',
  email:'<rect x="35" y="39" width="74" height="50" rx="7"/><path d="m39 45 33 24 33-24"/>',
  "email-plus":'<rect x="31" y="42" width="70" height="47" rx="7"/><path d="m35 48 31 22 31-22"/><path d="M108 28v22M97 39h22" stroke="#FFB21E"/>',
  clipboard:'<rect x="43" y="37" width="58" height="57" rx="6"/><path d="M58 37v-8h28v8"/><path d="M56 54h32M56 67h32M56 80h23"/>',
  "clipboard-plus":'<rect x="39" y="39" width="56" height="55" rx="6"/><path d="M53 39v-8h28v8"/><path d="M52 56h29M52 68h25"/><path d="M108 29v22M97 40h22" stroke="#FFB21E"/>',
  ...
  link:'<path d="M61 42H48a20 20 0 0 0 0 40h13"/><path d="M83 42h13a20 20 0 0 1 0 40H83"/><path d="M55 62h34"/>',
  reply:'<path d="M57 43 35 62l22 19"/><path d="M39 62h34c20 0 31 8 35 23"/>',
  followup:'<path d="M48 45a31 31 0 1 1-6 39"/><path d="M48 45V29M48 45H31"/><path d="M72 47v17l12 7"/>',
...
const BUILTIN_VISUALS = new Map([
  ...
  ["pro-follow-up",["followup","FOLLOW UP"]],
