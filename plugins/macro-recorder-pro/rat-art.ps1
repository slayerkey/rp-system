...
if (-not (Get-Command python -ErrorAction SilentlyContinue)) {
    throw "Python is required to generate macro-recorder-pro Rat Art."
}
...
$Work = Join-Path ([System.IO.Path]::GetTempPath()) ("packrat-macro-recorder-pro-art-" + [guid]::NewGuid().ToString("N"))
New-Item -ItemType Directory -Force -Path $Work | Out-Null
try {
    $Cover = Join-Path $Work "02_cover.png"
    Write-Host "Macro Recorder Rat Art: rendering macro-recorder-pro Marketplace media..." -ForegroundColor DarkGray
    python $Renderer --slug macro-recorder-pro --out $Cover
    ...
    $mapping = [ordered]@{
        ...
        "03-library.png" = "04_gallery_02.png"
        "04-playback.png" = "05_gallery_03.png"
