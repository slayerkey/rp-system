...
$Helper = Join-Path $Root "com.packrat.monitormanagerpro.sdPlugin\helper\monitor-helper.ps1"
...
Write-Host "MONITOR MANAGER PRO HOST AUDIT PASS" -ForegroundColor Green
