...
Not affiliated with, endorsed by, or sponsored by the NFL or any team. Team names, abbreviations
...
```
npm install            # once
npm run build          # rollup -> com.packrat.nfl-tracker.sdPlugin/bin/plugin.js
npm test               # runs the shared test suite in ../_shared
npx streamdeck validate com.packrat.nfl-tracker.sdPlugin
python ../_shared/scripts/gen_teams.py nfl-tracker football the NFL
